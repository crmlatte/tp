    ...
    public static Person[] getSamplePersons() {
        return new Person[]{
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                    ...
                    DEFAULT_GITHUB, new ProjectTeam("WealthVault"), getTagSet("friends"), new Progress("20")),
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                        new ClassNumber("T04"), new StudentId("A0000002B"),
                    DEFAULT_GITHUB, new ProjectTeam("Rawrness"), getTagSet("colleagues", "friends"),
                    new Progress("35")),
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                        new ClassNumber("R01"), new StudentId("A0000003B"),
                    DEFAULT_GITHUB, new ProjectTeam("Rawrness"), getTagSet("neighbours"), new Progress("80")),
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                        new ClassNumber(DEFAULT_CLASS), new StudentId("A0000004B"),
                    DEFAULT_GITHUB, new ProjectTeam("Bim Bim Bap"), getTagSet("family"), new Progress("15")),
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                        new ClassNumber("R10"), new StudentId("A0000005B"),
                    DEFAULT_GITHUB, new ProjectTeam("Rawrness"), getTagSet("classmates"),
                    new Progress("60")),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                        new ClassNumber("T04"), new StudentId("A0000006B"),
                    DEFAULT_GITHUB, new ProjectTeam("WealthVault"),
