...
public class Github {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Githubs links should be of the format https://github.com/{username} "
            + "in the form [github url]/username "
            + "and adhere to the following constraints:\n"
            + "1. The github url part should only contain alphanumeric characters and these special characters, excluding "
            + "the parentheses, (" + SPECIAL_CHARACTERS + "). The github url part may not start or end with any special "
            + "characters, particularly in the format ' https://github.com ' .\n"
            + "2. This is followed by a '/' and then a username. The username is made up of alphanumeric characters "
            + "separated by dashes (-).\n"
            + "The username must:\n"
    ...
    public Github(String github) {
        ...
        checkArgument(isValidEmail(github), MESSAGE_CONSTRAINTS);
        value = github;
    }
